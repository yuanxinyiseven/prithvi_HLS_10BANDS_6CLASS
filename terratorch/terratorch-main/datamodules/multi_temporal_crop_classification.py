...
MEANS = {
    ...
    # "SWIR_2": 1739.579917,
    "Band_1": 1000.0,
    "Band_2": 1000.0, "Band_3": 1000.0,  # ─── 补上你数据中可能被读取出的波段名 ───
    "Band_4": 1000.0, "Band_5": 1000.0, "Band_6": 1000.0,
}
...
STDS = {
    ...
    # "SWIR_1": 951.900334,
    # "SWIR_2": 921.407808,
    "Band_1": 500.0, "Band_2": 500.0, "Band_3": 500.0,    # ─── 同步补上标准差 ───
    "Band_4": 500.0, "Band_5": 500.0, "Band_6": 500.0,
}
...
class MultiTemporalCropClassificationDataModule(NonGeoDataModule):
    ...
    def __init__(
        ...
        batch_size: int = 4,
        num_workers: int = 0,
        bands: Sequence[str] = ("Band_1", "Band_2", "Band_3", "Band_4", "Band_5", "Band_6"),
